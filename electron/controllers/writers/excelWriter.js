XLSX = require("xlsx");
const { getExcelData, mapFields, getWorksheet } = require("../readers/excelReader");
const { findPriceField, findNameField, findQuantityField} = require("../synonyms");
